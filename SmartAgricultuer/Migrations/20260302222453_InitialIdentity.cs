...
namespace SmartAgricultuer.Migrations
{
    ...
    public partial class InitialIdentity : Migration
    {
        ...
        {
            // 1. جداول الـ Identity الأساسية (دي مش موجودة عندك ولازم تنزل)
            ...
            // 2. تحديث جدول الـ Uploads عشان يتربط بـ AspNetUsers (بما إنه موجود، هنعدل الـ Constraint بس)
            migrationBuilder.AddForeignKey(
                name: "FK_Uploads_AspNetUsers_user_id",
                table: "Uploads",
                column: "user_id",
            ...
            // 3. إنشاء الـ Indexes الخاصة بالـ Identity
